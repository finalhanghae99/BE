...
public class UserInformationController {
    ...
    public ResponseMessage<?> userReservationInfo(HttpServletRequest request){
        ResponseUserReservationDto responseUserReservationDto = userInformationService.userReservationInfo(request);
